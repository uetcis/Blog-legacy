$(document).ready(function() {
    (function() { var url = location.href; if (navigator.userAgent.match(/(iPhone|iPod|Android|ios|iPad)/i)) { document.getElementById("yukino").style.display = "none"; } })();
    Array.prototype.forEach.call(document.querySelectorAll(".mdl-card__media"), function(a) {
        ...
        if (!c) { return }
        a.addEventListener("click", function() { location.href = c })
    });
    $("#visitor-url").focus(function() { this.placeholder = "http://" });
    $("#visitor-url").blur(function() { this.placeholder = "" });
    $(".search-input").blur(function() {
        this.value = "";
        this.placeholder = ""
    });
    $("#article-fuctions-share-button, #article-functions-viewtags-button").click(function() { $(".is-visible").removeClass("is-visible") });
    $(".fabs .prev, .fabs .next, .fabs .prev-content").addClass("fab");
    $("a.toTop").click(function() { $("html, body").animate({ scrollTop: $($(this).attr("href")).offset().top + "px" }, { duration: 500, easing: "swing" }); return false });
    $(".post-toc a").click(function() { $("html, body").animate({ scrollTop: $($(this).attr("href")).offset().top + "px" }, { duration: 500, easing: "swing" }); return false });
    $(document).click(function() { if ($("#prime").hasClass("is-visible")) { $("#prime").click() } });
    $("#prime").click(function(a) { a.stopPropagation(); return false });
    $(document).click(function() { $("#local-search-result ul").css("display", "none") })
});
$(window).scroll(function(c) { var a = $(window).scrollTop(); if (a > 300) { $("#back-to-top").addClass("btt-visible") } else { $("#back-to-top").removeClass("btt-visible") } var b = $(".mdl-mini-footer").offset().top; var d = $(window).height(); if (a > b - d + 42) { $("#back-to-top").addClass("btt-docked") } else { $("#back-to-top").removeClass("btt-docked") } });

function MaterialButton(a) { this.element_ = a, this.init() }

function MaterialCheckbox(a) { this.element_ = a, this.init() }

function MaterialIconToggle(a) { this.element_ = a, this.init() }

function MaterialMenu(a) { this.element_ = a, this.init() }

function MaterialProgress(a) { this.element_ = a, this.init() }

function MaterialRadio(a) { this.element_ = a, this.init() }

function MaterialSlider(a) { this.element_ = a, this.isIE_ = window.navigator.msPointerEnabled, this.init() }

function MaterialSpinner(a) { this.element_ = a, this.init() }

function MaterialSwitch(a) { this.element_ = a, this.init() }

function MaterialTabs(a) { this.element_ = a, this.init() }
...
function MaterialTab(d, b) {
    if (d) {
        ...
        d.addEventListener("click", function(f) {
            f.preventDefault();
            var e = d.href.split("#")[1],
                g = b.element_.querySelector("#" + e);
...
function MaterialTextfield(a) { this.element_ = a, this.maxRows = this.Constant_.NO_MAX_ROWS, this.init() }

function MaterialTooltip(a) { this.element_ = a, this.init() }

function MaterialLayout(a) { this.element_ = a, this.init() }
...
function MaterialLayoutTab(g, d, f, c) {
    if (g) {
        ...
        g.addEventListener("click", function(j) {
            j.preventDefault();
            var i = g.href.split("#")[1],
                e = c.content_.querySelector("#" + i);
            c.resetTabState_(d), c.resetPanelState_(f), g.classList.add(c.CssClasses_.IS_ACTIVE), e.classList.add(c.CssClasses_.IS_ACTIVE)
        })
    }
}

function MaterialDataTable(a) { this.element_ = a, this.init() }

function MaterialRipple(a) { this.element_ = a, this.init() }
var componentHandler = function() {
    function w(d, a) { for (var c = 0; c < y.length; c++) { if (y[c].className === d) { return void 0 !== a && (y[c] = a), y[c] } } return !1 }

    function D(c) { var a = c.getAttribute("data-upgraded"); return null === a ? [""] : a.split(",") }

    function E(d, c) { var a = D(d); return -1 !== a.indexOf(c) }

    function q(h, i) {
        if (void 0 === h && void 0 === i) { for (var e = 0; e < y.length; e++) { q(y[e].className, y[e].cssClass) } } else {
            var c = h;
            if (void 0 === i) {
                var n = w(c);
                n && (i = n.cssClass)
            }
            for (var u = document.querySelectorAll("." + i), p = 0; p < u.length; p++) { k(u[p], c) }
        }
    }

    function k(F, t) {
        if (!("object" == typeof F && F instanceof Element)) { throw new Error("Invalid argument provided to upgrade MDL element.") }
        var I = D(F),
            C = [];
        if (t) { E(F, t) || C.push(w(t)) } else {
            var c = F.classList;
            y.forEach(function(a) { c.contains(a.cssClass) && -1 === C.indexOf(a) && !E(F, a.className) && C.push(a) })
        }
        for (var s, H = 0, J = C.length; J > H; H++) {
            if (s = C[H], !s) { throw new Error("Unable to find a registered component for the given class.") }
            I.push(s.className), F.setAttribute("data-upgraded", I.join(","));
            var G = new s.classConstructor(F);
            G[f] = s, B.push(G);
            for (var e = 0, K = s.callbacks.length; K > e; e++) { s.callbacks[e](F) }
    ...
    function z(h) { Array.isArray(h) || (h = "function" == typeof h.item ? Array.prototype.slice.call(h) : [h]); for (var c, d = 0, a = h.length; a > d; d++) { c = h[d], c instanceof HTMLElement && (c.children.length > 0 && z(c.children), k(c)) } }

    function m(c) {
        var d = { classConstructor: c.constructor, className: c.classAsString, cssClass: c.cssClass, widget: void 0 === c.widget ? !0 : c.widget, callbacks: [] };
        if (y.forEach(function(h) { if (h.cssClass === d.cssClass) { throw new Error("The provided cssClass has already been registered.") } if (h.className === d.className) { throw new Error("The provided className has already been registered") } }), c.constructor.prototype.hasOwnProperty(f)) { throw new Error("MDL component classes must not have " + f + " defined as a property.") }
    ...
    function j() { for (var a = 0; a < y.length; a++) { q(y[a].className) } }

    function x(d) { for (var a = 0; a < B.length; a++) { var c = B[a]; if (c.element_ === d) { return c } } }
    ...
    function A(h) {
        if (h && h[f].classConstructor.prototype.hasOwnProperty(g)) {
            ...
            var c = B.indexOf(h);
            B.splice(c, 1);
            var d = h.element_.getAttribute("data-upgraded").split(","),
                a = d.indexOf(h[f].classAsString);
    ...
    function v(d) {
        var a = function(h) { A(x(h)) };
        if (d instanceof Array || d instanceof NodeList) { for (var c = 0; c < d.length; c++) { a(d[c]) } } else {
            if (!(d instanceof Node)) { throw new Error("Invalid argument provided to downgrade MDL nodes.") }
            a(d)
        }
    }
    var y = [],
    ...
    return { upgradeDom: q, upgradeElement: k, upgradeElements: z, upgradeAllRegistered: j, registerUpgradedCallback: b, register: m, downgradeElements: v }
}();
window.addEventListener("load", function() { "classList" in document.createElement("div") && "querySelector" in document && "addEventListener" in window && Array.prototype.forEach ? (document.documentElement.classList.add("mdl-js"), componentHandler.upgradeAllRegistered()) : componentHandler.upgradeElement = componentHandler.register = function() {} }),
    function() {
        ...
        if (/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) || !window.requestAnimationFrame || !window.cancelAnimationFrame) {
            ...
            window.requestAnimationFrame = function(h) {
                var f = Date.now(),
                    g = Math.max(a + 16, f);
                return setTimeout(function() { h(a = g) }, g - f)
            }, window.cancelAnimationFrame = clearTimeout
        }
    }(), MaterialButton.prototype.Constant_ = {}, MaterialButton.prototype.CssClasses_ = { RIPPLE_EFFECT: "mdl-js-ripple-effect", RIPPLE_CONTAINER: "mdl-button__ripple-container", RIPPLE: "mdl-ripple" }, MaterialButton.prototype.blurHandler = function(a) { a && this.element_.blur() }, MaterialButton.prototype.disable = function() { this.element_.disabled = !0 }, MaterialButton.prototype.enable = function() { this.element_.disabled = !1 }, MaterialButton.prototype.init = function() {
        if (this.element_) {
        ...
        if (this.element_) {
            ...
            var m = this.element_.getAttribute("for"),
                g = null;
            ...
            for (var d = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), j = 0; j < d.length; j++) { d[j].addEventListener("click", this.handleItemClick_.bind(this)), d[j].tabIndex = "-1", d[j].addEventListener("keydown", this.handleItemKeyboardEvent_.bind(this)) }
            if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
        ...
        if (this.element_ && this.forElement_) {
            var a = this.forElement_.getBoundingClientRect(),
                b = this.forElement_.parentElement.getBoundingClientRect();
        ...
        if (this.element_ && this.container_) {
            ...
            if (b && b.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
                ...
                if (d.keyCode === this.Keycodes_.UP_ARROW) { d.preventDefault(), c > 0 ? b[c - 1].focus() : b[b.length - 1].focus() } else {
                    if (d.keyCode === this.Keycodes_.DOWN_ARROW) { d.preventDefault(), b.length > c + 1 ? b[c + 1].focus() : b[0].focus() } else {
        ...
        if (this.element_ && this.container_ && this.outline_) {
            var f = this.element_.getBoundingClientRect().height,
                g = this.element_.getBoundingClientRect().width;
            ...
            this.applyClip_(f, g), window.requestAnimationFrame(function() { this.element_.classList.add(this.CssClasses_.IS_ANIMATING), this.element_.style.clip = "rect(0 " + g + "px " + f + "px 0)", this.container_.classList.add(this.CssClasses_.IS_VISIBLE) }.bind(this)), this.addAnimationEndListener_();
            var h = function(a) { a === j || this.closing_ || (document.removeEventListener("click", h), this.hide()) }.bind(this);
            document.addEventListener("click", h)
        }
    }, MaterialMenu.prototype.hide = function() {
        if (this.element_ && this.container_ && this.outline_) {
            for (var d = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), b = 0; b < d.length; b++) { d[b].style.transitionDelay = null }
            var c = this.element_.getBoundingClientRect().height,
                a = this.element_.getBoundingClientRect().width;
    ...
    }, MaterialMenu.prototype.toggle = function(a) { this.container_.classList.contains(this.CssClasses_.IS_VISIBLE) ? this.hide() : this.show(a) }, componentHandler.register({ constructor: MaterialMenu, classAsString: "MaterialMenu", cssClass: "mdl-js-menu", widget: !0 }), MaterialProgress.prototype.Constant_ = {}, MaterialProgress.prototype.CssClasses_ = { INDETERMINATE_CLASS: "mdl-progress__indeterminate" }, MaterialProgress.prototype.setProgress = function(a) { this.element_.classList.contains(this.CssClasses_.INDETERMINATE_CLASS) || (this.progressbar_.style.width = a + "%") }, MaterialProgress.prototype.setBuffer = function(a) { this.bufferbar_.style.width = a + "%", this.auxbar_.style.width = 100 - a + "%" }, MaterialProgress.prototype.init = function() {
        if (this.element_) {
    ...
    }, componentHandler.register({ constructor: MaterialRadio, classAsString: "MaterialRadio", cssClass: "mdl-js-radio", widget: !0 }), MaterialSlider.prototype.Constant_ = {}, MaterialSlider.prototype.CssClasses_ = { IE_CONTAINER: "mdl-slider__ie-container", SLIDER_CONTAINER: "mdl-slider__container", BACKGROUND_FLEX: "mdl-slider__background-flex", BACKGROUND_LOWER: "mdl-slider__background-lower", BACKGROUND_UPPER: "mdl-slider__background-upper", IS_LOWEST_VALUE: "is-lowest-value", IS_UPGRADED: "is-upgraded" }, MaterialSlider.prototype.onInput_ = function(a) { this.updateValueStyles_() }, MaterialSlider.prototype.onChange_ = function(a) { this.updateValueStyles_() }, MaterialSlider.prototype.onMouseUp_ = function(a) { a.target.blur() }, MaterialSlider.prototype.onContainerMouseDown_ = function(b) {
        if (b.target === this.element_.parentElement) {
            b.preventDefault();
            var a = new MouseEvent("mousedown", { target: b.target, buttons: b.buttons, clientX: b.clientX, clientY: this.element_.getBoundingClientRect().y });
    ...
    }, MaterialSlider.prototype.disable = function() { this.element_.disabled = !0 }, MaterialSlider.prototype.enable = function() { this.element_.disabled = !1 }, MaterialSlider.prototype.change = function(a) { a && (this.element_.value = a), this.updateValueStyles_() }, MaterialSlider.prototype.init = function() {
        if (this.element_) {
            if (this.isIE_) {
    ...
    }, MaterialSwitch.prototype.mdlDowngrade_ = function() { this.rippleContainerElement_ && this.rippleContainerElement_.removeEventListener("mouseup", this.boundMouseUpHandler), this.inputElement_.removeEventListener("change", this.boundChangeHandler), this.inputElement_.removeEventListener("focus", this.boundFocusHandler), this.inputElement_.removeEventListener("blur", this.boundBlurHandler), this.element_.removeEventListener("mouseup", this.boundMouseUpHandler) }, componentHandler.register({ constructor: MaterialSwitch, classAsString: "MaterialSwitch", cssClass: "mdl-js-switch", widget: !0 }), MaterialTabs.prototype.Constant_ = {}, MaterialTabs.prototype.CssClasses_ = { TAB_CLASS: "mdl-tabs__tab", PANEL_CLASS: "mdl-tabs__panel", ACTIVE_CLASS: "is-active", UPGRADED_CLASS: "is-upgraded", MDL_JS_RIPPLE_EFFECT: "mdl-js-ripple-effect", MDL_RIPPLE_CONTAINER: "mdl-tabs__ripple-container", MDL_RIPPLE: "mdl-ripple", MDL_JS_RIPPLE_EFFECT_IGNORE_EVENTS: "mdl-js-ripple-effect--ignore-events" }, MaterialTabs.prototype.initTabs_ = function(b) {
    ...
    }, MaterialTooltip.prototype.handleMouseLeave_ = function(a) { a.stopPropagation(), this.element_.classList.remove(this.CssClasses_.IS_ACTIVE), window.removeEventListener("scroll", this.boundMouseLeaveHandler), window.removeEventListener("touchmove", this.boundMouseLeaveHandler, !1) }, MaterialTooltip.prototype.init = function() {
        if (this.element_) {
        ...
        if (this.element_) {
            ...
            if (this.header_ && this.tabBar_) {
                ...
                A.classList.add(this.CssClasses_.ICON), A.textContent = this.Constant_.CHEVRON_LEFT, x.appendChild(A), x.addEventListener("click", function() { this.tabBar_.scrollLeft -= this.Constant_.TAB_SCROLL_PIXELS }.bind(this));
                var v = document.createElement("div");
                v.classList.add(this.CssClasses_.TAB_BAR_BUTTON), v.classList.add(this.CssClasses_.TAB_BAR_RIGHT_BUTTON);
                var y = document.createElement("i");
                y.classList.add(this.CssClasses_.ICON), y.textContent = this.Constant_.CHEVRON_RIGHT, v.appendChild(y), v.addEventListener("click", function() { this.tabBar_.scrollLeft += this.Constant_.TAB_SCROLL_PIXELS }.bind(this)), j.appendChild(x), j.appendChild(this.tabBar_), j.appendChild(v);
                ...
                for (var g = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), f = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), F = 0; F < g.length; F++) { new MaterialLayoutTab(g[F], g, f, this) }
            }
        ...
        if (this.element_) {
            var j = this.element_.querySelector("th"),
                f = this.element_.querySelector("tbody").querySelectorAll("tr");
            if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
                var g = document.createElement("th"),
                    d = this.createCheckbox_(null, f);
                g.appendChild(d), j.parentElement.insertBefore(g, j);
                for (var k = 0; k < f.length; k++) {
                    var c = f[k].querySelector("td");
                    if (c) {
                        var b = document.createElement("td"),
                            h = this.createCheckbox_(f[k]);
    ...
    }, componentHandler.register({ constructor: MaterialDataTable, classAsString: "MaterialDataTable", cssClass: "mdl-js-data-table" }), MaterialRipple.prototype.Constant_ = { INITIAL_SCALE: "scale(0.0001, 0.0001)", INITIAL_SIZE: "1px", INITIAL_OPACITY: "0.4", FINAL_OPACITY: "0", FINAL_SCALE: "" }, MaterialRipple.prototype.CssClasses_ = { RIPPLE_CENTER: "mdl-ripple--center", RIPPLE_EFFECT_IGNORE_EVENTS: "mdl-js-ripple-effect--ignore-events", RIPPLE: "mdl-ripple", IS_ANIMATING: "is-animating", IS_VISIBLE: "is-visible" }, MaterialRipple.prototype.downHandler_ = function(j) {
        ...
        if (this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE), "mousedown" === j.type && this.ignoringMouseDown_) { this.ignoringMouseDown_ = !1 } else {
            "touchstart" === j.type && (this.ignoringMouseDown_ = !0);
            var g = this.getFrameCount();
            if (g > 0) { return }
            this.setFrameCount(1);
            var d, k, c = j.currentTarget.getBoundingClientRect();
            if (0 === j.clientX && 0 === j.clientY) { d = Math.round(c.width / 2), k = Math.round(c.height / 2) } else {
                var b = j.clientX ? j.clientX : j.touches[0].clientX,
                    h = j.clientY ? j.clientY : j.touches[0].clientY;
    ...
    }, MaterialRipple.prototype.upHandler_ = function(a) { a && 2 !== a.detail && this.rippleElement_.classList.remove(this.CssClasses_.IS_VISIBLE) }, MaterialRipple.prototype.init = function() {
        if (this.element_) {
...
if ("undefined" == typeof jQuery) { throw new Error("Bootstrap's JavaScript requires jQuery") } + function(d) {
    function c() {
    ...
    i.VERSION = "3.2.0", i.prototype.close = function(a) {
        function n() { k.detach().trigger("closed.bs.alert").remove() }
        var m = g(this),
    ...
    var h = g.fn.alert;
    g.fn.alert = f, g.fn.alert.Constructor = i, g.fn.alert.noConflict = function() { return g.fn.alert = h, this }, g(document).on("click.bs.alert.data-api", j, i.prototype.close)
}(jQuery), + function(f) {
    function e(a) {
        return this.each(function() {
            var i = f(this),
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = { loadingText: "loading..." }, h.prototype.setState = function(a) {
        var l = "disabled",
            ...
            i = k.data();
        a += "Text", null == i.resetText && k.data("resetText", k[j]()), k[j](null == i[a] ? this.options[a] : i[a]), setTimeout(f.proxy(function() { "loadingText" == a ? (this.isLoading = !0, k.addClass(l).attr(l, l)) : this.isLoading && (this.isLoading = !1, k.removeClass(l).removeAttr(l)) }, this), 0)
    }, h.prototype.toggle = function() {
        var i = !0,
            d = this.$element.closest('[data-toggle="buttons"]');
        if (d.length) { var j = this.$element.find("input"); "radio" == j.prop("type") && (j.prop("checked") && this.$element.hasClass("active") ? i = !1 : d.find(".active").removeClass("active")), i && j.prop("checked", !this.$element.hasClass("active")).trigger("change") }
        i && this.$element.toggleClass("active")
    };
    var g = f.fn.button;
    f.fn.button = e, f.fn.button.Constructor = h, f.fn.button.noConflict = function() { return f.fn.button = g, this }, f(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(b) {
        var a = f(b.target);
    ...
    function e(a) {
        return this.each(function() {
            var j = f(this),
                ...
                c = f.extend({}, h.DEFAULTS, j.data(), "object" == typeof a && a),
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = { interval: 5000, pause: "hover", wrap: !0 }, h.prototype.keydown = function(b) {
        ...
        b.preventDefault()
    }, h.prototype.cycle = function(a) { return a || (this.paused = !1), this.interval && clearInterval(this.interval), this.options.interval && !this.paused && (this.interval = setInterval(f.proxy(this.next, this), this.options.interval)), this }, h.prototype.getItemIndex = function(b) { return this.$items = b.parent().children(".item"), this.$items.index(b || this.$active) }, h.prototype.to = function(a) {
        var j = this,
            i = this.getItemIndex(this.$active = this.$element.find(".item.active"));
        return a > this.$items.length - 1 || 0 > a ? void 0 : this.sliding ? this.$element.one("slid.bs.carousel", function() { j.to(a) }) : i == a ? this.pause().cycle() : this.slide(a > i ? "next" : "prev", f(this.$items[a]))
    }, h.prototype.pause = function(a) { return a || (this.paused = !0), this.$element.find(".next, .prev").length && f.support.transition && (this.$element.trigger(f.support.transition.end), this.cycle(!0)), this.interval = clearInterval(this.interval), this }, h.prototype.next = function() { return this.sliding ? void 0 : this.slide("next") }, h.prototype.prev = function() { return this.sliding ? void 0 : this.slide("prev") }, h.prototype.slide = function(x, w) {
        ...
        var p = u[0],
            o = f.Event("slide.bs.carousel", { relatedTarget: p, direction: s });
        if (this.$element.trigger(o), !o.isDefaultPrevented()) {
            ...
            return f.support.transition && this.$element.hasClass("slide") ? (u.addClass(x), u[0].offsetWidth, v.addClass(s), u.addClass(s), v.one("bsTransitionEnd", function() { u.removeClass([x, s].join(" ")).addClass("active"), v.removeClass(["active", s].join(" ")), q.sliding = !1, setTimeout(function() { q.$element.trigger(a) }, 0) }).emulateTransitionEnd(1000 * v.css("transition-duration").slice(0, -1))) : (v.removeClass("active"), u.addClass("active"), this.sliding = !1, this.$element.trigger(a)), t && this.cycle(), this
        }
    };
    var g = f.fn.carousel;
    f.fn.carousel = e, f.fn.carousel.Constructor = h, f.fn.carousel.noConflict = function() { return f.fn.carousel = g, this }, f(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", function(l) {
        var k, j = f(this),
            i = f(j.attr("data-target") || (k = j.attr("href")) && k.replace(/.*(?=#[^\s]+$)/, ""));
        if (i.hasClass("carousel")) {
            var b = f.extend({}, i.data(), j.data()),
                a = j.attr("data-slide-to");
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = { toggle: !0 }, h.prototype.dimension = function() { var b = this.$element.hasClass("width"); return b ? "width" : "height" }, h.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(l), !l.isDefaultPrevented()) {
                ...
                var b = function() { this.$element.removeClass("collapsing").addClass("collapse in")[i](""), this.transitioning = 0, this.$element.trigger("shown.bs.collapse") };
    ...
    var g = f.fn.collapse;
    f.fn.collapse = e, f.fn.collapse.Constructor = h, f.fn.collapse.noConflict = function() { return f.fn.collapse = g, this }, f(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(r) {
        var q, p = f(this),
            o = p.attr("data-target") || r.preventDefault() || (q = p.attr("href")) && q.replace(/.*(?=#[^\s]+$)/, ""),
            n = f(o),
            m = n.data("bs.collapse"),
            l = m ? "toggle" : p.data(),
            b = p.attr("data-parent"),
            a = b && f(b);
    ...
    var k = j.fn.dropdown;
    j.fn.dropdown = o, j.fn.dropdown.Constructor = l, j.fn.dropdown.noConflict = function() { return j.fn.dropdown = k, this }, j(document).on("click.bs.dropdown.data-api", i).on("click.bs.dropdown.data-api", ".dropdown form", function(b) { b.stopPropagation() }).on("click.bs.dropdown.data-api", m, l.prototype.toggle).on("keydown.bs.dropdown.data-api", m + ', [role="menu"], [role="listbox"]', l.prototype.keydown)
}(jQuery), + function(f) {
    function e(a, c) {
        return this.each(function() {
            var i = f(this),
    ...
    var h = function(a, d) { this.options = d, this.$body = f(document.body), this.$element = f(a), this.$backdrop = this.isShown = null, this.scrollbarWidth = 0, this.options.remote && this.$element.find(".modal-content").load(this.options.remote, f.proxy(function() { this.$element.trigger("loaded.bs.modal") }, this)) };
    h.VERSION = "3.2.0", h.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }, h.prototype.toggle = function(b) { return this.isShown ? this.hide() : this.show(b) }, h.prototype.show = function(a) {
        var j = this,
            i = f.Event("show.bs.modal", { relatedTarget: a });
        this.$element.trigger(i), this.isShown || i.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.$body.addClass("modal-open"), this.setScrollbar(), this.escape(), this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', f.proxy(this.hide, this)), this.backdrop(function() {
            ...
            c ? j.$element.find(".modal-dialog").one("bsTransitionEnd", function() { j.$element.trigger("focus").trigger(b) }).emulateTransitionEnd(300) : j.$element.trigger("focus").trigger(b)
        }))
    }, h.prototype.hide = function(a) { a && a.preventDefault(), a = f.Event("hide.bs.modal"), this.$element.trigger(a), this.isShown && !a.isDefaultPrevented() && (this.isShown = !1, this.$body.removeClass("modal-open"), this.resetScrollbar(), this.escape(), f(document).off("focusin.bs.modal"), this.$element.removeClass("in").attr("aria-hidden", !0).off("click.dismiss.bs.modal"), f.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", f.proxy(this.hideModal, this)).emulateTransitionEnd(300) : this.hideModal()) }, h.prototype.enforceFocus = function() { f(document).off("focusin.bs.modal").on("focusin.bs.modal", f.proxy(function(b) { this.$element[0] === b.target || this.$element.has(b.target).length || this.$element.trigger("focus") }, this)) }, h.prototype.escape = function() { this.isShown && this.options.keyboard ? this.$element.on("keyup.dismiss.bs.modal", f.proxy(function(b) { 27 == b.which && this.hide() }, this)) : this.isShown || this.$element.off("keyup.dismiss.bs.modal") }, h.prototype.hideModal = function() {
        var b = this;
        this.$element.hide(), this.backdrop(function() { b.$element.trigger("hidden.bs.modal") })
    }, h.prototype.removeBackdrop = function() { this.$backdrop && this.$backdrop.remove(), this.$backdrop = null }, h.prototype.backdrop = function(a) {
        var l = this,
            k = this.$element.hasClass("fade") ? "fade" : "";
        if (this.isShown && this.options.backdrop) {
            var j = f.support.transition && k;
            if (this.$backdrop = f('<div class="modal-backdrop ' + k + '" />').appendTo(this.$body), this.$element.on("click.dismiss.bs.modal", f.proxy(function(b) { b.target === b.currentTarget && ("static" == this.options.backdrop ? this.$element[0].focus.call(this.$element[0]) : this.hide.call(this)) }, this)), j && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !a) { return }
            j ? this.$backdrop.one("bsTransitionEnd", a).emulateTransitionEnd(150) : a()
        } else {
            if (!this.isShown && this.$backdrop) {
                this.$backdrop.removeClass("in");
                var i = function() { l.removeBackdrop(), a && a() };
                f.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one("bsTransitionEnd", i).emulateTransitionEnd(150) : i()
            } else { a && a() }
        }
    }, h.prototype.checkScrollbar = function() { document.body.clientWidth >= window.innerWidth || (this.scrollbarWidth = this.scrollbarWidth || this.measureScrollbar()) }, h.prototype.setScrollbar = function() {
        var b = parseInt(this.$body.css("padding-right") || 0, 10);
        this.scrollbarWidth && this.$body.css("padding-right", b + this.scrollbarWidth)
    }, h.prototype.resetScrollbar = function() { this.$body.css("padding-right", "") }, h.prototype.measureScrollbar = function() {
        var d = document.createElement("div");
    ...
    var g = f.fn.modal;
    f.fn.modal = e, f.fn.modal.Constructor = h, f.fn.modal.noConflict = function() { return f.fn.modal = g, this }, f(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(k) {
        var j = f(this),
            i = j.attr("href"),
            b = f(j.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")),
            a = b.data("bs.modal") ? "toggle" : f.extend({ remote: !/#/.test(i) && i }, b.data(), j.data());
        j.is("a") && k.preventDefault(), b.one("show.bs.modal", function(c) { c.isDefaultPrevented() || b.one("hidden.bs.modal", function() { j.is(":visible") && j.trigger("focus") }) }), e.call(b, a, this)
    })
}(jQuery), + function(f) {
    function e(a) {
        return this.each(function() {
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = { animation: !0, placement: "top", selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1, viewport: { selector: "body", padding: 0 } }, h.prototype.init = function(a, p, o) {
        ...
        for (var n = this.options.trigger.split(" "), m = n.length; m--;) {
            var l = n[m];
            if ("click" == l) { this.$element.on("click." + this.type, this.options.selector, f.proxy(this.toggle, this)) } else {
                if ("manual" != l) {
    ...
    }, h.prototype.getDefaults = function() { return h.DEFAULTS }, h.prototype.getOptions = function(a) { return a = f.extend({}, this.getDefaults(), this.$element.data(), a), a.delay && "number" == typeof a.delay && (a.delay = { show: a.delay, hide: a.delay }), a }, h.prototype.getDelegateOptions = function() {
        var a = {},
            d = this.getDefaults();
        return this._options && f.each(this._options, function(b, c) { d[b] != c && (a[b] = c) }), a
    }, h.prototype.enter = function(a) { var d = a instanceof this.constructor ? a : f(a.currentTarget).data("bs." + this.type); return d || (d = new this.constructor(a.currentTarget, this.getDelegateOptions()), f(a.currentTarget).data("bs." + this.type, d)), clearTimeout(d.timeout), d.hoverState = "in", d.options.delay && d.options.delay.show ? void(d.timeout = setTimeout(function() { "in" == d.hoverState && d.show() }, d.options.delay.show)) : d.show() }, h.prototype.leave = function(a) { var d = a instanceof this.constructor ? a : f(a.currentTarget).data("bs." + this.type); return d || (d = new this.constructor(a.currentTarget, this.getDelegateOptions()), f(a.currentTarget).data("bs." + this.type, d)), clearTimeout(d.timeout), d.hoverState = "out", d.options.delay && d.options.delay.hide ? void(d.timeout = setTimeout(function() { "out" == d.hoverState && d.hide() }, d.options.delay.hide)) : d.hide() }, h.prototype.show = function() {
        ...
        isNaN(u) && (u = 0), isNaN(t) && (t = 0), z.top = z.top + u, z.left = z.left + t, f.offset.setOffset(x[0], f.extend({ using: function(b) { x.css({ top: Math.round(b.top), left: Math.round(b.left) }) } }, z), 0), x.addClass("in");
        var s = x[0].offsetWidth,
            r = x[0].offsetHeight;
        "top" == y && r != v && (z.top = z.top + v - r);
        var q = this.getViewportAdjustedDelta(y, z, s, r);
        q.left ? z.left += q.left : z.top += q.top;
        var p = q.left ? 2 * q.left - w + s : 2 * q.top - v + r,
            o = q.left ? "left" : "top",
            a = q.left ? "offsetWidth" : "offsetHeight";
        x.offset(z), this.replaceArrow(p, x[0][a], o)
    }, h.prototype.replaceArrow = function(i, d, j) { this.arrow().css(j, i ? 50 * (1 - i / d) + "%" : "") }, h.prototype.setContent = function() {
        var d = this.tip(),
            c = this.getTitle();
        d.find(".tooltip-inner")[this.options.html ? "html" : "text"](c), d.removeClass("fade in top bottom left right")
    }, h.prototype.hide = function() {
        function a() { "in" != k.hoverState && j.detach(), k.$element.trigger("hidden.bs." + k.type) }
        var k = this,
            j = this.tip(),
    ...
    }, h.prototype.hasContent = function() { return this.getTitle() }, h.prototype.getPosition = function(a) {
        a = a || this.$element;
        var j = a[0],
            i = "BODY" == j.tagName;
        return f.extend({}, "function" == typeof j.getBoundingClientRect ? j.getBoundingClientRect() : null, { scroll: i ? document.documentElement.scrollTop || document.body.scrollTop : a.scrollTop(), width: i ? f(window).width() : a.outerWidth(), height: i ? f(window).height() : a.outerHeight() }, i ? { top: 0, left: 0 } : a.offset())
    }, h.prototype.getCalculatedOffset = function(j, i, l, k) { return "bottom" == j ? { top: i.top + i.height, left: i.left + i.width / 2 - l / 2 } : "top" == j ? { top: i.top - k, left: i.left + i.width / 2 - l / 2 } : "left" == j ? { top: i.top + i.height / 2 - k / 2, left: i.left - l } : { top: i.top + i.height / 2 - k / 2, left: i.left + i.width } }, h.prototype.getViewportAdjustedDelta = function(v, u, t, s) {
        var r = { top: 0, left: 0 };
    ...
    }, h.prototype.getUID = function(b) { do { b += ~~(1000000 * Math.random()) } while (document.getElementById(b)); return b }, h.prototype.tip = function() { return this.$tip = this.$tip || f(this.options.template) }, h.prototype.arrow = function() { return this.$arrow = this.$arrow || this.tip().find(".tooltip-arrow") }, h.prototype.validate = function() { this.$element[0].parentNode || (this.hide(), this.$element = null, this.options = null) }, h.prototype.enable = function() { this.enabled = !0 }, h.prototype.disable = function() { this.enabled = !1 }, h.prototype.toggleEnabled = function() { this.enabled = !this.enabled }, h.prototype.toggle = function(a) {
        var d = this;
    ...
    h.VERSION = "3.2.0", h.DEFAULTS = f.extend({}, f.fn.tooltip.Constructor.DEFAULTS, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>' }), h.prototype = f.extend({}, f.fn.tooltip.Constructor.prototype), h.prototype.constructor = h, h.prototype.getDefaults = function() { return h.DEFAULTS }, h.prototype.setContent = function() {
        var i = this.tip(),
            d = this.getTitle(),
            j = this.getContent();
    ...
    }, h.prototype.hasContent = function() { return this.getTitle() || this.getContent() }, h.prototype.getContent = function() {
        var d = this.$element,
            c = this.options;
    ...
    e.VERSION = "3.2.0", e.DEFAULTS = { offset: 10 }, e.prototype.getScrollHeight = function() { return this.$scrollElement[0].scrollHeight || Math.max(this.$body[0].scrollHeight, document.documentElement.scrollHeight) }, e.prototype.refresh = function() {
        ...
        }).sort(function(d, c) { return d[0] - c[0] }).each(function() { i.offsets.push(this[0]), i.targets.push(this[1]) })
        ...
        for (j = m.length; j--;) { k != l[j] && i >= m[j] && (!m[j + 1] || i <= m[j + 1]) && this.activate(l[j]) }
    ...
    f.fn.scrollspy = h, f.fn.scrollspy.Constructor = e, f.fn.scrollspy.noConflict = function() { return f.fn.scrollspy = g, this }, f(window).on("load.bs.scrollspy.data-api", function() {
    ...
    h.VERSION = "3.2.0", h.prototype.show = function() {
        var a = this.element,
            m = a.closest("ul:not(.dropdown-menu)"),
            l = a.data("target");
        if (l || (l = a.attr("href"), l = l && l.replace(/.*(?=#[^\s]*$)/, "")), !a.parent("li").hasClass("active")) {
            var k = m.find(".active:last a")[0],
                j = f.Event("show.bs.tab", { relatedTarget: k });
        ...
        function k() { j.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"), a.addClass("active"), i ? (a[0].offsetWidth, a.addClass("in")) : a.removeClass("fade"), a.parent(".dropdown-menu") && a.closest("li.dropdown").addClass("active"), l && l() }
        var j = m.find("> .active"),
            i = l && f.support.transition && j.hasClass("fade");
        i ? j.one("bsTransitionEnd", k).emulateTransitionEnd(150) : k(), j.removeClass("in")
    };
    var g = f.fn.tab;
    f.fn.tab = e, f.fn.tab.Constructor = h, f.fn.tab.noConflict = function() { return f.fn.tab = g, this }, f(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"]', function(a) { a.preventDefault(), e.call(f(this), "show") })
}(jQuery), + function(f) {
    function e(a) {
        return this.each(function() {
            var i = f(this),
    ...
    h.VERSION = "3.2.0", h.RESET = "affix affix-top affix-bottom", h.DEFAULTS = { offset: 0, target: window }, h.prototype.getPinnedOffset = function() {
        if (this.pinnedOffset) { return this.pinnedOffset }
        this.$element.removeClass(h.RESET).addClass("affix");
        var d = this.$target.scrollTop(),
            c = this.$element.offset();
        return this.pinnedOffset = c.top - d
    }, h.prototype.checkPositionWithEventLoop = function() { setTimeout(f.proxy(this.checkPosition, this), 1) }, h.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            var r = f(document).height(),
                q = this.$target.scrollTop(),
    ...
    var g = f.fn.affix;
    f.fn.affix = e, f.fn.affix.Constructor = h, f.fn.affix.noConflict = function() { return f.fn.affix = g, this }, f(window).on("load", function() {
...
$(document).ready(function() {
    ...
    $("#sidebar-position").change(function() {
        ...
        if (e == "sidebar-fixed-left") { $(".sidebar-overlay").addClass("active") }
    })
});
(function(a) {
    var b = a(".dropdown");
    b.on("show.bs.dropdown", function(c) { a(this).find(".dropdown-menu").first().stop(true, true).slideDown() });
    b.on("hide.bs.dropdown", function(c) { a(this).find(".dropdown-menu").first().stop(true, true).slideUp() })
})(jQuery);
(function(a) {
        ...
        if (e && typeof e.test === "function") {
            for (var c = 0, b = this.length; c < b; c++) {
                ...
                if (d.nodeType === 1 && d.className) {
                    ...
                    for (var g = f.length; g--;) { if (e.test(f[g])) { f.splice(g, 1) } }
